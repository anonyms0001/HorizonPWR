...
class AddressesControllerTest < ActionDispatch::IntegrationTest
  class WithPermissionAddressesControllerTest < AddressesControllerTest
    setup do
  ...
  class WithoutPermissionAddressesControllerTest < AddressesControllerTest
    setup do
      @address = addresses(:one)
      @user = users(:nobody)
      login_as @user
    ...
    test "should not create address" do
      assert_no_difference("Address.count") do
        post addresses_url, params: {address: {address: @address.address, address_type: @address.address_type, latitude: @address.latitude, longitude: @address.longitude}}
      end
    ...
    test "should not show address" do
      get address_url(@address)
      assert_redirected_to root_url
      follow_redirect!
      assert_select "body", /You do not have enough permissions to access that. Please, ask your manager to update your permissions./
