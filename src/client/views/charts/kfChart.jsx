...
export default view(function KFChart() {
    ...
    let companyLeads = weekScores[1].Leads
    let companySits = weekScores[1].Qs
    let companyCloses = weekScores[1].Closes
    let companyInstalls = weekScores[1].Installs
    ...
    return (
        ...
        <div id="kfChart" className={teamState === "Klamath Falls" ? "active" : "inactive"}>
            {/*<h4 style={{textAlign: "center"}}>FOX </h4>*/}
