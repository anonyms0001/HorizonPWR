...
export default view(function RexburgChart() {
    ...
    let companyLeads = weekScores[2].Leads
    let companySits = weekScores[2].Qs
    let companyCloses = weekScores[2].Closes
    let companyInstalls = weekScores[2].Installs
    ...
    return (
        ...
        <div id="rexChart" className={teamState === "Rexburg" ? "active" : "inactive"}>
            {/*<h4 style={{textAlign: "center"}}>REXBURG </h4>*/}
            <div style={{width: "20%", display: "inline-block"}}>
                <Doughnut data={companyLeadsChart} width={50} height={50} options={{ tooltips: {enabled:false}, hover: {mode:null}}}/>
                <div style={{textAlign: "center"}}>LEADS <br/> <span style={{visibility: "hidden"}}>l</span></div>
            </div>

            <div style={{width: "20%", display: "inline-block"}}>
                <Doughnut data={companySitsChart} width={50} height={50} options={{ tooltips: {enabled:false}, hover: {mode:null}}}/>
                <div style={{textAlign: "center"}}>SITS<br/> <span style={{visibility: "hidden"}}>l</span></div>
            </div>

            <div style={{width: "20%", display: "inline-block"}}>
                <Doughnut data={companyClosesChart} width={50} height={50} options={{ tooltips: {enabled:false}, hover: {mode:null}}}/>
                <div style={{textAlign: "center"}}>CLOSES <br/> <span style={{visibility: "hidden"}}>l</span></div>
            </div>

            <div style={{width: "20%", display: "inline-block"}}>
                <Doughnut data={companyInstallsChart} width={50} height={50} options={{ tooltips: {enabled:false}, hover: {mode:null}}}/>
