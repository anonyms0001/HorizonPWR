...
export default view(function OregonChart() {
   ...
   const {weekScores} = weekStatsStore
    ...
    let companyLeads = statesScore[1].Leads
    let companySits = statesScore[1].Qs
    let companyCloses = statesScore[1].Closes
    let companyInstalls = statesScore[1].Installs


    // for (let i = 0; i < weekScores.length; i++) {
    //     if(weekScores[i].Team === "Fox" ){
    ...
    return (
        <div id="idahoChart" className={teamState === "Oregon" ? "active" : "inactive"} >
