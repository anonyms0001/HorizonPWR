...
export default view(function LeaderBoard() {
            ...
            <div className="container">
                ...
                <div className="tab-section">
                    <div className="tab-option-holder">
                        <div className={tableMode === 'team' ? "teams-icon tab-option active" : "teams-icon tab-option"} onClick={changeTable.bind(this, teamScores, 'team')}><div className="icon-badge"></div>Teams</div>
                        <div className={tableMode === 'ec' || tableMode === 'fm' ? "topreps-icon tab-option active" : "teams-icon tab-option"}  onClick={changeTable.bind(this, energyConsultants, 'ec')}><div className="icon-badge"></div>Top Reps</div>
                    </div>
                        ...
                        <div id="topreps" className={tableMode !== 'team' ? "tab-content-bottom active" : "tab-content-bottom"}>
                            <div className="table-header">
                                <table className={tableMode === "ec" ? "table-ec active" : "table-ec"}>
                                    <thead>
                                        <tr>
                                            <th className="ec-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Name" })}>Rep</th>
                                            <th className="ec-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Score" })}>Score</th>
                                            <th className="ec-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Leads" })}>Leads</th>
                                            <th className="ec-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Qs" })}>QS</th>
                                            <th className="ec-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Closes" })}>Close</th>
                                            <th className="ec-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "AssistedInstalls" })}>Assisted Installs</th>
                                            <th className="ec-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "SelfGenInstall" })}>Self Generated Installs</th>
                                        </tr>
                                    </thead>
                                </table>
                                <table className={tableMode === "fm" ? "table-fm active" : "table-fm"}>
                                    <thead>
                                        <tr>
                                            <th className="fm-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Name" })}>Rep</th>
                                            <th className="fm-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Score" })}>Score</th>
                                            <th className="fm-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Leads" })}>Leads</th>
                                            <th className="fm-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Qs" })}>QS</th>
                                            <th className="fm-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "AssistedCloses" })}>Assisted Close</th>
                                            <th className="fm-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "AssistedInstalls" })}>Assisted Installs</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
