...
import TotalEarningsHistorical from '../comissions/totalEarningsWidgetHistorical'
...
import UpfrontCommissionsHistorical from "../comissions/upfrontCommissionsHistorical"

import BackEndCommissionsHistorical from "../comissions/backEndCommissionsHistorical"
import OverrideCommissions from "../comissions/overrideCommissions"
import OverrideCommissionsHistorical from "../comissions/overrideCommissionsHistorical"
            ...
            <div id="repsdashboard" className="container">
                ...
                <div className="row">
                    <div className="col-md-6">
                        {/*<SitsEarningWidget />*/}
                        {overrideDetected ? <OverrideCommissionsHistorical/> : ''}
                        {sessionStore.user.roleId === '7' || sessionStore.user.roleId === '8' ?
                            <FMSitsWidget/> : <UpfrontCommissionsHistorical/>}
                        {sessionStore.user.roleId === '7' || sessionStore.user.roleId === '8' ? <AssistEarningsWidget/> :
                            <BackEndCommissionsHistorical/>}
                        {/*{ sessionStore.user.roleId === '7' || sessionStore.user.roleId === '8' ? <FMSitsWidget/> : '' }*/}
                        {/*    /!*<CustomerConcessions/>*!/*/}
                    </div>
                    <div className="col-md-6">
                        {sessionStore.user.roleId === '7' || sessionStore.user.roleId === '8' ? <TotalEarningsFM/> : <TotalEarningsHistorical/>}
                    </div>
                </div>
            </div>
        </div>
