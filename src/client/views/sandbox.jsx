...
export default view(function Sandbox() {
    ...
    if (currentTable) {
        ...
        console.log("energy consultant", energyConsultants[1]);
    }
                        ...
                        <div id="topreps" className={tableMode !== 'team' ? "tab-content-bottom active" : "tab-content-bottom"}>
                            <div class="table-header">
                                ...
                                <table className={tableMode === "fm" ? "table-fm active" : "table-fm"}>
                                    <thead>
                                        <tr>
                                            <th class="fm-sort" param="DESC" onClick={() => emit.SelectedStatsSortBy({ sortBy: "Name" })}>Rep</th>
