...
@view
export default class CashBoard extends React.Component {

    render() {
        const {selectedFundingCard, fundingBoardAlert, proposalFundingReloading, financialPartnersFunding, cashExpanded} = fundingStore
        const {user} = sessionStore

        let fundingPayments = financialPartnersFunding.Cash
        ...
        function expandToogle() {
            if (cashExpanded) {
                emit.ClickedExpandedBtn({financePartner: 'cash', selectedState: false})
            } else {
                emit.ClickedExpandedBtn({financePartner: 'cash', selectedState: true})
            }
        }
                ...
                <div className="panel  panel-default" style={{margin: "0px", boxShadow: "none"}}>
                    <div className="panel-heading">
                        <div style={{display: "flex"}}>
                            <div style={{flex: "1", textAlign: "left", fontSize: "1.3em"}}>Cash Funding
                    ...
                    <div id='funding-body-panel' className="panel-body"
                         style={cashExpanded ? {display: "block", padding: "0px"} : {display: "none"}}>
