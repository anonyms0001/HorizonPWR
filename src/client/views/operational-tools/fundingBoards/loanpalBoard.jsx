...
@view
export default class LoanPalBoard extends React.Component {

    render() {
        const {selectedFundingCard, fundingBoardAlert, proposalFundingReloading, financialPartnersFunding, loanPalExpanded} = fundingStore
        const {user} = sessionStore

        let fundingPayments = financialPartnersFunding.LoanPal
        ...
        for (let i = 0; i < fundingPayments.length; i++) {
            ...
            //First Payment
            if (!fundingPayments[i].X1st_Funding_Payment_Received__c && fundingPayments[i].Finance_Partner__c !== 'Generations' && fundingPayments[i].Loan_Docs_Signed_Date_Time__c) {
        ...
        function expandToogle() {
            if (loanPalExpanded) {
                emit.ClickedExpandedBtn({financePartner: 'loanPal', selectedState: false})
            } else {
                emit.ClickedExpandedBtn({financePartner: 'loanPal', selectedState: true})
            }
        }
                ...
                <div className="panel  panel-default" style={{margin: "0px", boxShadow: "none"}}>
                    <div className="panel-heading">
                        <div style={{display: "flex"}}>
                            <div style={{flex: "1", textAlign: "left", fontSize: "1.3em"}}>Loanpal - Needs First
                    ...
                    <div id='funding-body-panel' className="panel-body"
                         style={loanPalExpanded ? {display: "block", padding: "0px"} : {display: "none"}}>
