...
@view
export default class FundingBoard extends React.Component {

    render() {
        const {fundingPayments, selectedFundingCard, fundingBoardAlert, proposalFundingReloading} = fundingStore
     ...
     function formatMoney(amount, decimalCount = 2, decimal = ".", thousands = ",") {
        ...
        function checkSecondValidation(amount) {
            ...
            if (secondAmountVal === comparedAmount) {
                ...
                document.getElementById('second-btn-submit').classList.add("disabled")
            }
        }
        ...
        return (
            <section id='funding-board' className="pwrstation-view-profile" >
                ...
                <div className="row" style={{marginTop: "1em"}}>
                    <div className="col-xs-12">
                        {proposalFundingReloading ?
                            <div id='loading-overlay'><img id="spinner" style={{
                            height: "40%",
                            maxHeight: "70px",
                            margin: "0"
                        ...
                        <div className="panel  panel-default">
                            <div className="panel-heading">
                                <div style={{display: "flex"}}>
                                    <div style={{flex: "1", textAlign: "left", fontSize: "1.3em"}}>Funding Payments
                                    </div>
                            ...
                            <div id='funding-body-panel' className="panel-body" style={{padding: "0px"}}>
