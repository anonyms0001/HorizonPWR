class EarningTypesController < ApplicationController
  ...
  def earning_type_params
    params.require(:earning_type).permit(:name, :display_name, :preferred_financial_option, :percent, earning_rates_attributes: [:amount, :range_top, :range_bottom, :earning_type_id, :active, :job_position_id])
  end
end
