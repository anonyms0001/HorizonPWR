  ...
  def incomplete_state_block
    ...
    content_block = if blocked
      <<~HTML
        ...
        <a href="#{routes.proposal_unblocked_path(self)}" style="margin-left: 0 !important;" class="flex-grow text-base font-medium leading-normal text-indigo-700 bg-indigo-100 px-6 py-3 shadow rounded-md">
          Un-Block Proposal
        </a>
      HTML
